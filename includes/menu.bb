...
spr_start = LoadSprite( "GFX\TEMP\TEMP_GO.PNG", 7, camera_player )	
...
spr_quit = LoadSprite( "GFX\TEMP\TEMP_NO.PNG", 7, camera_player )		
...
spr_credits = LoadSprite( "GFX\TEMP\TEMP_WHO.PNG", 7, camera_player )	;lists all the cool people
